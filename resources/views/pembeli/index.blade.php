    ...
    <ul class="navbar-nav mr-auto">
      ...
      <TABLE class="table table-hover">
        ...
        <tr>
            ...
            <td>{{ $pembeli->telp}}</td>
            <td>
            <a href="/pembeli/{{$pembeli->id_pembeli}}/edit" class="btn btn-warning btn-sm">Edit</a>
            <a href="/pembeli/{{$pembeli->id_pembeli}}/delete" class="btn btn-danger btn-sm" onclick ="return confirm('Apakah anda yakin?')">Delete</a>
